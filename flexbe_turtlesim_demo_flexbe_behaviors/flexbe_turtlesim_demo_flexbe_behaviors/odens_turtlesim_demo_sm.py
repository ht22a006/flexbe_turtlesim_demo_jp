...
# Copyright 2024 ISHIKAWA Hiroki
#
...
"""
Define ODENS Turtlesim Demo.

Created on Tue Feb 27 2024
@author: ISHIKAWA Hiroki
"""
...
class ODENSTurtlesimDemoSM(Behavior):
    """
    Define ODENS Turtlesim Demo.
    ...
    def __init__(self, node):
        super().__init__()
        self.name = 'ODENS Turtlesim Demo'
    ...
    def create(self):
        ...
        with _state_machine:
            ...
            # x:739 y:403
            OperatableStateMachine.add('CircleMove',
                                       TimedCmdVelState(target_time=5.0, velocity=2.5, rotation_rate=2.0, cmd_topic=cmd_vel, desired_rate=50),
            ...
            OperatableStateMachine.add('Operator',
                                       OperatorDecisionState(outcomes=["Home", "Eight", "Quit", "Clear", "Rotate", "Pose","Circle"], hint="Suggest 'Eight' for pattern move", suggestion="Eight"),
                                       transitions={'Home': 'GoHome', 'Eight': 'EightMove', 'Quit': 'finished', 'Clear': 'ClearLog', 'Rotate': 'Turtlesim Input State Behavior', 'Pose': 'GoTo', 'Circle': 'CircleMove'},
                                       autonomy={'Home': Autonomy.Full, 'Eight': Autonomy.High, 'Quit': Autonomy.Full, 'Clear': Autonomy.Full, 'Rotate': Autonomy.Full, 'Pose': Autonomy.Full, 'Circle': Autonomy.Off})
